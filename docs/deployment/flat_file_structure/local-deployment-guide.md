...
This guide provides step-by-step instructions for deploying your CPTM8 platform on **Kind (Kubernetes in Docker)** for local development using the <ins>*flat file structure*</ins>. Kind is perfect for learning Kubernetes without cloud costs.

> **Suggestion**: Highly recommended to use the base+overlays file structure even for a development environment.
...
### Development (Kind) - NodePort Services** ⭐ Recommended

> **Note:** See the frontend exposure guide to access to the frontend:
> - [Frontend Exposure Guide](./frontend-exposure-guide.md)
...
- Check **frontend-exposure-guide.md** (./frontend-exposure-guide.md) for accessing your web applications
